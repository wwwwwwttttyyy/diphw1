...
def parse_args():
    ...
    p.add_argument('--downsample_factor', type=int, default=None,
                   help='Override training image downsampling factor')
    p.add_argument('--maximum_pts_num', type=int, default=None,
                   help='Override the number of sampled COLMAP points')
    return p.parse_args()
...
def main():
    ...
    downsample_factor = args.downsample_factor or train_config.get(
        'downsample_factor', 8
    )
    maximum_pts_num = args.maximum_pts_num or train_config.get(
    ...
    dataset = ColmapDataset(
        ...
        maximum_pts_num=maximum_pts_num,
    )
    sample = dataset[0]
